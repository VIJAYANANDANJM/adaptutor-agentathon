...
This module knows nothing about quizzes, diagnoses, or explanations. It knows
how to move a run through states, how to stop, and how to resume. The domain
lives in remediation/flow.py - which is the file you rewrite for your own
problem.
...
class Flow(Protocol):
    """What a domain must provide. See remediation/flow.py."""
    name: str
